...
public:
    ...
    bool get_is_present_len() const { return m_is_present_len; }
    void set_is_present_len(bool is_present_len) { m_is_present_len = is_present_len; }

    std::optional<int64_t> get_update_offset() const { return m_update_offset; }
    void set_update_offset(std::optional<int64_t> update_offset) { m_update_offset = update_offset; }
