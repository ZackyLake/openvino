...
void TransformationsPipeline::apply(std::shared_ptr<ov::Model> func) {
    ...
    }
    {
        ...
        if (enableQDQStripping) {
            ...
            qdq_stripping_manager.register_pass<ov::pass::ConvertQuantizeDequantize>(TypeVector{i16, u16}, TypeVector{f16, f32});
...

    {
        ...
        manager.register_pass<ov::pass::RewireMatMulDim3>();
