...
ONNXModelEditor::ONNXModelEditor(std::shared_ptr<ModelProto> model_proto, const std::string& model_path, frontend::ExtensionHolder extensions)
    : m_model_path{model_path},
...
ONNXModelEditor::ONNXModelEditor(std::shared_ptr<ModelProto> model_proto, frontend::ExtensionHolder extensions)
    : ONNXModelEditor(model_proto, "", extensions) {}
