...
InputModel::InputModel(std::shared_ptr<ModelProto> model_proto, const std::string& path, frontend::ExtensionHolder extensions)
    : m_editor{std::make_shared<ONNXModelEditor>(model_proto, path, std::move(extensions))} {}
